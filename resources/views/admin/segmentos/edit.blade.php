...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Editar segmento cadastrado</h1>
            </div>
        </div><!--/.row-->

        {!! Form::open(['route'=>['admin.segmentos.update', $segmento->id], 'method'=>'put', 'role'=>'form'])  !!}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('titulo',  $segmento->titulo, ['class'=>'form-control']) !!}
                            </div>


                            <div class="form-group">
                                {!! Form::label('slug', 'Slug:') !!}
                                {!! Form::text('slug', $segmento->slug, ['class'=>'form-control']) !!}
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="lead">
                        ...
                        Tem certeza que quer colocar o segmento {{ $segmento->titulo }}, na lixeira?
                    </p>
                </div>
                <div class="modal-footer">
                    <form method="POST" action="{{ route('admin.segmentos.destroy', $segmento->id) }}">
