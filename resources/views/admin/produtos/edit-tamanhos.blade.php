...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tamanhos e quantidades produto {{ $tamanho->produto->titulo }}</h1>
            </div>
        </div><!--/.row-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default ">
                            <div class="panel-body">
                                <div class="col-md-12 ">
                                    <a href="{{ route('admin.produtos.edit', $tamanho->produto->id) }}" class="btn btn-default btn-md">Voltar para o produto</a>
